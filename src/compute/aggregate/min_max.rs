...
pub fn max(array: &dyn Array) -> Result<Box<dyn Scalar>> {
    Ok(match array.data_type() {
        ...
        DataType::Float32 => dyn_float!(f32, array, max_f32),
        DataType::Float64 => dyn_float!(f64, array, max_f64),
...
pub fn min(array: &dyn Array) -> Result<Box<dyn Scalar>> {
    Ok(match array.data_type() {
        ...
        DataType::Float16 => unreachable!(),
        DataType::Float32 => dyn_float!(f32, array, min_f32),
        DataType::Float64 => dyn_float!(f64, array, min_f64),
